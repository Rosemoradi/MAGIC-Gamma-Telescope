...
# Step 7: Set up the KNN model and parameter grid
...
y_score = best_model.predict_proba(X_test_pca)[:, 1]  # Use probabilities for class 1
...
plt.title('Receiver Operating Characteristic (KNN with PCA)')
