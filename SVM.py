...
# Verify scaling
print("Mean of training data after scaling:", X_train.mean(axis=0))
print("Standard deviation of training data after scaling:", X_train.std(axis=0))

# Step 6: Set up the SVM model and parameter grid
